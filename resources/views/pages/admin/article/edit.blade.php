        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="mb-2 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="flex items-center justify-between p-6">
                    <div class="text-lg font-bold text-primary_hover">Edit Data Artikel</div>
            ...
            <div class="overflow-hidden bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <form class="mx-auto max-w-full"
                    action="{{ route('admin.article.update', ['article' => $article->uuid]) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 gap-3">
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        id="author" name="author" type="text" value="{{ $article->author }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                        id="title" name="title" type="text" value="{{ $article->title }}"
                                        placeholder="Judul Article...." required />
                                </div>
                                <div class="mb-3">
                                    <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"
                                    ...
                                    <textarea
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                        id="content" name="content" rows="4" placeholder="Tuliskan Konten yang Menrarik">{{ $article->content }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-center p-5">
                                <img class="h-32 w-32 object-cover" id="imagePreview"
                                    src="{{ asset('thumbnail/' . $article->thumbnail) }}" alt="" />
                            </div>
                            <div class="mt-3">
