<x-landing-layout>
    ...
    <section class="bg-white px-8 py-16 text-gray-900" id="contact">
        <div class="container mx-auto text-left">
            <h2 class="mb-8 text-3xl font-bold text-center" >Hubungi Kami</h2>
            <p class="mb-2 flex text-center"><svg class="w-6 mr-2 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
